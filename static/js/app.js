...
// Explicitly attach to window for global access from HTML onclick
window.loadAdminMasterHospitals = loadAdminMasterHospitals;
window.triggerMasterScrape = triggerMasterScrape;
window.stopMasterScrape = stopMasterScrape;
window.startMasterStatusPolling = startMasterStatusPolling;
window.updateMasterScrapeStatus = updateMasterScrapeStatus;
